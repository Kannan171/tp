...
public class CommandTestUtil {
    ...
    public static final String VALID_MODULE_CS = "CS2103T";
    public static final String VALID_MODULE_MA = "MA1522";
    ...
    public static final String MODULE_DESC_CS = " " + PREFIX_MODULE + VALID_MODULE_CS;
    public static final String MODULE_DESC_MA = " " + PREFIX_MODULE + VALID_MODULE_MA;
    ...
    public static final String INVALID_MODULE_DESC = " " + PREFIX_MODULE + "CS21"; // Number should be 4 digits
    ...
    static {
        ...
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                ...
                .withModules(VALID_MODULE_MA).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
    }
